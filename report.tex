...
\maketitle
\abstract{
In this review I discuss the experimental set up of spin resolved ARPES and \lowercase{spin orbit coupling in materials}.
}
...
As covered in the above section, ARPES measures both the energy and momentum degrees of freedom but ignores the spin of the detected electrons.
Spin ARPES (SARPES) measures all three quantum numbers simultaneously and allows for a much richer understanding of the band structure of materials.
Accomplishing this is more technically challenging than it appears at first glance.
A Stern-Gerlach experiment would be the most direct way to investigate spin polarization, but because of the Lorentz force it is impossible to measure charged particles this way.
