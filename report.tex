...
In both types of materials, the spin of photo-emitted electrons contains information about the spin asymmetry in the sample.
...
\begin{align}
  \label{eq:soc}
  -\frac{e\hbar\boldsymbol{\sigma\cdot p \times E}}{4m_0^2c^2}=-\frac{e^2\hbar\boldsymbol{\sigma\cdot p \times r}}{4m_0^2c^2r^3}\newline=\frac{\boldsymbol{\hat{S}\cdot \hat{L}}}{2m_0^2c^2r^3}=\frac{\boldsymbol{\nabla}V\times\boldsymbol{p}\cdot\hat{\boldsymbol{S}}}{2m_0^2c^2}
\end{align}
...
Relativistic corrections for an electron in the gas moving with velocity $\boldsymbol{v}$ will give rise to an effective magnetic field $\boldsymbol{B}=\frac{\boldsymbol{E}\times\boldsymbol{p}}{c^2}$.
...
\end{align}
The factor $\alpha_{\text{R}}$ is treated as a coupling; it is well defined in this toy derivation but in real materials it can have complicated dependencies.
Now we have the total Hamiltonian
\begin{align}
  \label{eq:totalH}
  H=H_{\text{free}}+H_{\text{R}}=\frac{\hbar^2\boldsymbol{k}_\parallel^2}{2m}+\alpha_{\text{R}}(k_x\hat{\boldsymbol{S}}_y-k_y\hat{\boldsymbol{S}}_x)\text{,}
\end{align}
giving eigenvalues
\begin{align}
  \label{eq:eigenvalues}
  E_k=\frac{\hbar^2\boldsymbol{k}_{\parallel}}{2m}\pm\alpha_{R}|\boldsymbol{k}_{\parallel}\text{.}
\end{align}

\begin{figure}[h]
  \centering
  \includegraphics[width=2in]{fig/rashba.pdf}
  \caption[should I put this here?]
  {caption needed Taken from \cite{Dil}}
  \label{fig:asymmetry}
\end{figure}
In a real crystal, space-inversion symmetry is broken at the edge of the material.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=2in]{fig/cophee.pdf}
  \caption[should I put this here?]
...
\begin{figure}[h]
  \centering
  \includegraphics[width=2in]{fig/espresso.pdf}
  \caption[should I put this here?]
